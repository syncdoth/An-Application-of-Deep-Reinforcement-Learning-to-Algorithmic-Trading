...
class MovingAveragesTF(tradingStrategy):
    ...
    def plotTraining(self, results, bounds, step, marketSymbol):
        ...
        ax.view_init(45, 45)
        plt.savefig(''.join(
            ['Figures/', str(marketSymbol), '_MATFOptimization3D', '.png']))
        #plt.show()
        ...
        plt.savefig(''.join(
            ['Figures/', str(marketSymbol), '_MATFOptimization2D', '.png']))
        #plt.show()
...
class MovingAveragesMR(tradingStrategy):
    ...
    def plotTraining(self, results, bounds, step, marketSymbol):
        ...
        ax.view_init(45, 45)
        plt.savefig(''.join(
            ['Figures/', str(marketSymbol), '_MAMROptimization3D', '.png']))
        #plt.show()
        ...
        plt.gca().invert_yaxis()
        plt.savefig(''.join(
            ['Figures/', str(marketSymbol), '_MAMROptimization2D', '.png']))
        #plt.show()
